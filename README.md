...
___
The basis behind the Apollo Music review site, was to start a flask web app which allows users to search for music reviews, wether this is a professional release, from EDM to house music, to contemporary and amateur releases. In a very easy and intuitive and visual was regarding UX. My primary aim was to bring together many of the technologies i have learned so far to then use these technologies and display data in a comprehensive way. I aim to bring in user generated data using forms (through a Add review form page) and python linked to MongoDB so that my web app has the ability to expand and grow with ease as users can 
